    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('process_status', models.PositiveSmallIntegerField(choices=[(0, 'SUCCESS'), (1, 'NOT STARTED'), (2, 'PROCESSING'), (3, 'INVALID YOUTUBE ID'), (4, 'DOWNLOAD ERROR'), (5, 'BEAT PROCESS ERROR')], default=1)),
